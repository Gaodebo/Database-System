...
* [数据库系统概论-教材-王珊版-本地](file:///D:/learn_work/数据库/数据库系统概论-第5版.pdf)
* [数据库课程-课件-战德臣-本地](file:///D:/learn_work/数据库/6.0数据库三级/数据库课件整理.pdf)
...
*  一致性Consistency: DBMS保证事务的操作状态是正确的，符合一致性的操 作规则，它是进一步由隔离性来保证的
